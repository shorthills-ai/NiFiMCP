...
EMBEDDING_DEPLOYMENT_NAME = os.getenv("AZURE_OPENAI_EMBEDDINGS_DEPLOYMENT", "text-embedding-ada-002")
LLM_DEPLOYMENT_NAME = os.getenv("AZURE_OPENAI_DEPLOYMENT", "gpt-4o")
...
index_name = os.getenv("ES_EMBED_INDEX", "hrbot_embed")
# ------------------ LLM Usage Logger ------------------
...
logger = LLMUsageLogger(
    ...
    log_path=os.getenv("LLM_USAGE_LOG_PATH", "/home/nifi/nifi2/users/HR_Teams_Bot_Dev/llm_usage.log")
)
