...
Focus on:
- AI in the world (general advancements, breakthroughs)
- New AI tools and platforms
- Impacts of AI in the software industry and other sectors
- New Large Language Models (LLMs) releases and research
- News related to MCP (Model Context Protocol) servers using large language models
...
if full_response_text:
    try:
        news_data = json.loads(full_response_text)
